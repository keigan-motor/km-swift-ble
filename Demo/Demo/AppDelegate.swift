...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        guard let splitViewController = window?.rootViewController as? UISplitViewController,
            ...
            let demoViewController = splitViewController.viewControllers.last as? KMDemoViewController
            else { fatalError() }
        
        scanViewController.delegate = demoViewController
    ...
    func splitViewController(_ splitViewController: UISplitViewController, collapseSecondary secondaryViewController:UIViewController, onto primaryViewController:UIViewController) -> Bool {
        guard let secondaryController = secondaryViewController as? KMDemoViewController else { return false }
        if secondaryController.motor == nil {
